...
<head>
    ...
    <title>Tambah Prestasi - SIPRESMATU</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">Tambah Prestasi Baru</h4>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <form action="{{ route('mahasiswa.prestasi.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tingkat_lomba" name="tingkat_lomba" required>
                                    ...
                                    <option value="Kabupaten/Kota" {{ old('tingkat_lomba') == 'Kabupaten/Kota' ? 'selected' : '' }}>Kabupaten/Kota</option>
                                    <option value="Kampus" {{ old('tingkat_lomba') == 'Kampus' ? 'selected' : '' }}>Kampus</option>
                                </select>
                            </div>
