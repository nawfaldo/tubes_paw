...
<head>
    ...
    <title>Tambah Pendaftaran Lomba - SIPRESMATU Admin</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0">Tambah Pendaftaran Lomba</h4>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('admin.mahasiswa.pendaftaran.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
